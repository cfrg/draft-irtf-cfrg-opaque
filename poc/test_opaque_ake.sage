...
def test_3DH():
    ...
    for config in [default_opaque_configuration_base, default_opaque_configuration_custom]:
        ...
        inputs["client_private_keyshare"] = to_hex(I2OSP_le(client_kex.eskU, 32))
        inputs["client_keyshare"] = to_hex(ristretto255.ENCODE(*client_kex.epkU))
        inputs["server_private_keyshare"] = to_hex(I2OSP_le(server_kex.eskS, 32))
        inputs["server_keyshare"] = to_hex(ristretto255.ENCODE(*server_kex.epkS))
